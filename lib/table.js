...
var belongsTo = function(Model, configuration){
  this.associations.push(new BelongsTo(Model, configuration));  
}

var hasMany = function(Model, configuration){
  this.associations.push(new HasMany(Model, configuration));  
}

var hasOne = function(Model, configuration){
  this.associations.push(new HasOne(Model, configuration));  
}
